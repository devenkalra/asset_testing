...
assetsTest.describe('Box detail test', async () => {
	assetsTest(
		'Can CRUD box @TC_BOX_01',
		async ({ settingPage, homePage, commonComponent, addEditPage, landingPage }) => {
			...
			await assetsTest.step('2. Create new Box inside this Area', async () => {
				await commonComponent.buttonAdd.clickBtnAddMultiple();
			...
			await assetsTest.step('3. Go to detail of box, update that box', async () => {
			...
			await assetsTest.step('4. Can create new Box inside this Box', async () => {
				await commonComponent.buttonAdd.clickBtnAddMultiple();
				await commonComponent.buttonAdd.validateShowWhatToAddSection();
				await commonComponent.buttonAdd.clickAddBox();
			...
			await assetsTest.step('5. Can create new Item inside this 2nd Box', async () => {
				await commonComponent.buttonAdd.clickBtnAddMultiple();
				await commonComponent.buttonAdd.validateShowWhatToAddSection();
			...
			await assetsTest.step('6. Can delete Box inside this 2nd Box', async () => {
			...
			await assetsTest.step('7. Can delete Item inside this 2nd Box', async () => {
			...
			await assetsTest.step('8. Can delete 2nd box will return parent area', async () => {
				await commonComponent.detailPage.clickOnShowOption();
				await commonComponent.detailPage.validateShowActionOptions();
				await commonComponent.detailPage.clickDeleteOption();
				await commonComponent.detailPage.validateDetailTitleIs(testAreaName);
