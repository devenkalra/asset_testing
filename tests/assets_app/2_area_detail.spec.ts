...
assetsTest.describe('Area detail test', () => {
	...
	assetsTest(
		...
		async ({
			...
			await assetsTest.step('2. Create new Area inside this Area', async () => {
			...
			await assetsTest.step('3. Create new Box inside this Area', async () => {
				url = '';
				await commonComponent.buttonAdd.clickBtnAddSingle();
				await commonComponent.buttonAdd.validateShowWhatToAddSection();
			...
			await assetsTest.step('4. Create new Item inside this Area', async () => {
				url = '';
				await commonComponent.buttonAdd.clickBtnAddSingle();
				await commonComponent.buttonAdd.validateShowWhatToAddSection();
	...
	assetsTest(
		...
		async ({
			...
			await assetsTest.step('2. Create new mutiple Area inside this Area', async () => {
				await commonComponent.buttonAdd.clickBtnAddMultiple();
				await commonComponent.buttonAdd.validateShowWhatToAddSection();
				await commonComponent.buttonAdd.clickAddArea();
			...
			await assetsTest.step('3. Create new mutiple Boxes inside this Area', async () => {
				await commonComponent.buttonAdd.clickBtnAddMultiple();
				await commonComponent.buttonAdd.validateShowWhatToAddSection();
				await commonComponent.buttonAdd.clickAddBox();
			...
			await assetsTest.step('4. Create new mutiple Items inside this Area', async () => {
				await commonComponent.buttonAdd.clickBtnAddMultiple();
				await commonComponent.buttonAdd.validateShowWhatToAddSection();
				await commonComponent.buttonAdd.clickAddItem();
